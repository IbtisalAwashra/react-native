...
export default class App extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <MDBContainer>
            <MDBCol className="mb-5000 bg-danger">
            <h1>{this.getCurrentDate}</h1>
            <h1></h1>
            </MDBCol>
            <MDBCol className="mb-r bg-light pt-r">

              <h2 className="text-uppercase my-3 green ">FEB</h2> 
              ...
              <MDBRow className="mb-4">
                <MDBCol xl="3" md="6" className="mx-auto text-center">
                  <MDBBtn color="danger" rounded onClick={this.toggleModal}>
                    Add Event
                  </MDBBtn>
                </MDBCol>
              </MDBRow>
    ...
    return (
      <React.Fragment>
        ...
        {this.props.description && (
          <p className="p-2 mb-4  green lighten-5 green lighten-5">
            {this.props.description}
          </p>
        )}
      </React.Fragment>
